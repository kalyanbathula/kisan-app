...
export const collaboratorsImage = (collaborator) => {
    const collaboratorID = collaborator.toLowerCase();

    switch (collaboratorID) {
        case 'whatsloan':
            return 'https://www.kisanlink.in/wp-content/uploads/Whatsloan.jpeg';
        case 'hdfc':
            return "https://www.kisanlink.in/wp-content/uploads/HDFC.png";
        case 'gramcover':
            return "https://www.kisanlink.in/wp-content/uploads/gramcover.png";
        case 'eride':
            return "https://www.kisanlink.in/wp-content/uploads/eride.png";
        case 'sneha':
            return "https://www.kisanlink.in/wp-content/uploads/sneha.png";
        case 'chalimedafeeds':
            return "https://www.kisanlink.in/wp-content/uploads/Chalimeda-feeds.png";
        case 'agrocare':
            return "https://www.kisanlink.in/wp-content/uploads/agro-care.png";
        case 'aspee':
            return "https://www.kisanlink.in/wp-content/uploads/aspee.png";
        case 'barrix':
            return "https://www.kisanlink.in/wp-content/uploads/barrix.png";
        case 'crown':
            return "https://www.kisanlink.in/wp-content/uploads/crown-solar.png";
        case 'greenzone':
            return "https://www.kisanlink.in/wp-content/uploads/greenzone-1.png";
        case 'hyperpixel':
            return "https://www.kisanlink.in/wp-content/uploads/hyperpixel.png";
        case 'kisankraft':
            return "https://www.kisanlink.in/wp-content/uploads/kisankraft-1.png";
        case 'aps':
            return "https://www.kisanlink.in/wp-content/uploads/aps.png";
        case 'agreo':
            return "https://www.kisanlink.in/wp-content/uploads/Agreo-logo.png";
        case 'krishitek':
            return "https://www.kisanlink.in/wp-content/uploads/krishitek.jpg";
        case 'vue':
            return vue;
        case 'bootstrap':
            return bootstrap;
